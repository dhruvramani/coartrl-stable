...
def mlp_extractor(flat_observations, net_arch, act_fun):
    ...
    ob_rms = RunningMeanStd(shape=tf.shape(flat_observations))
    flat_observations = (flat_observations - ob_rms.mean) / ob_rms.std
    flat_observations = tf.clip_by_value(flat_observations, -5.0, 5.0)
