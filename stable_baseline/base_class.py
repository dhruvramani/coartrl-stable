...
from stable_baseline.policies import get_policy_from_name, ActorCriticPolicy
...
class ActorCriticRLModel(BaseRLModel):
    ...
    def load(cls, load_path, env=None, **kwargs):
        ...
        model = cls(policy=data["policy"], env=None, _init_setup_model=False, config=data["config"], env_name=data["env_name"])
